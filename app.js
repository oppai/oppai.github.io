...
var _user$project$Main$margin2 = A2(_debois$elm_mdl$Material_Options$css, 'margin', '4px 8px 4px 0px');
var _user$project$Main$margin1 = A2(_debois$elm_mdl$Material_Options$css, 'margin', '0');
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {mdl: a, windowSize: b, userCell: c, twitterCell: d, githubCell: e, facebookCell: f, wishlistCell: g, btcCoinCell: h, nemCoinCell: i, dogeCoinCell: j};
									};
								};
							};
						};
...
var _user$project$Main$CellModel = F5(
	function (a, b, c, d, e) {
		return {raised: a, image: b, cellType: c, url: d, color: e};
	});
var _user$project$Main$CoinCellModel = F7(
	function (a, b, c, d, e, f, g) {
		return {raised: a, image: b, qrImage: c, cellType: d, color: e, title: f, subtitle: g};
	});
var _user$project$Main$WindowResult = function (a) {
	return {ctor: 'WindowResult', _0: a};
};
var _user$project$Main$Raise = F2(
	function (a, b) {
		return {ctor: 'Raise', _0: a, _1: b};
	});
var _user$project$Main$userCellView = function (model) {
	var height = '264px';
	var width = '264px';
	return A2(
		_debois$elm_mdl$Material_Card$view,
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'height', height),
				_1: {
					ctor: '::',
					_0: _user$project$Main$margin2,
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Color$background(model.color),
						_1: {
							ctor: '::',
							_0: model.raised ? _debois$elm_mdl$Material_Elevation$e8 : _debois$elm_mdl$Material_Elevation$e2,
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Options$onMouseEnter(
										A2(_user$project$Main$Raise, model.cellType, true)),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onMouseLeave(
											A2(_user$project$Main$Raise, model.cellType, false)),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_debois$elm_mdl$Material_Card$media,
				{
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'url(\'',
							A2(_elm_lang$core$Basics_ops['++'], model.image, '\') center / cover'))),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'height', height),
						_1: {ctor: '[]'}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('kodam a.k.a. oppai'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Main$linkCellView = function (model) {
	var thumb_height = '96px';
	var thumb_width = '96px';
	var height = '128px';
	var width = '128px';
	return A2(
		_debois$elm_mdl$Material_Card$view,
						...
						},
						{
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$img,
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'height', thumb_height),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'width', thumb_width),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Main$coinCellView = F2(
		...
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
				...
				_0: A2(
					_debois$elm_mdl$Material_Options$css,
					'width',
					(_elm_lang$core$Native_Utils.cmp(width, 400) > 0) ? '534px' : '260px'),
				_1: {
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'height',
						(_elm_lang$core$Native_Utils.cmp(width, 400) > 0) ? '90px' : '100px'),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Color$background(model.color),
						_1: {
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.subtitle),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$img,
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$attribute(
										_elm_lang$html$Html_Attributes$src(model.qrImage)),
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '64px'),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '64px'),
											_1: {ctor: '[]'}
										}
									}
								},
		...
		A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$cs('page-content'),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-left', '50px'),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('kodam\'s profile page'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$Main$userCellView(model.userCell),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$Main$linkCellView(model.twitterCell),
														_1: {
															ctor: '::',
															_0: _user$project$Main$linkCellView(model.githubCell),
															_1: {
																ctor: '::',
																_0: _user$project$Main$linkCellView(model.facebookCell),
																_1: {
																	ctor: '::',
																	_0: _user$project$Main$linkCellView(model.wishlistCell),
																	_1: {ctor: '[]'}
																}
															}
														}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: A2(_user$project$Main$coinCellView, model.nemCoinCell, model.windowSize.width),
												_1: {
													ctor: '::',
													_0: A2(_user$project$Main$coinCellView, model.btcCoinCell, model.windowSize.width),
													_1: {
														ctor: '::',
														_0: A2(_user$project$Main$coinCellView, model.dogeCoinCell, model.windowSize.width),
														_1: {ctor: '[]'}
													}
												}
											}),
		...
		switch (_p0.ctor) {
			...
			default:
				switch (_p0._0.ctor) {
					...
					case 'TwitterCellType':
						var twittercell = model.twitterCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							twittercell,
							{raised: _p0._1});
						return {
					...
					case 'GithubCellType':
						var githubcell = model.githubCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							githubcell,
							{raised: _p0._1});
						return {
					...
					case 'FacebookCellType':
						var facebookcell = model.facebookCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							facebookcell,
							{raised: _p0._1});
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{facebookCell: newCell}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'WishlistCellType':
						var wishlistcell = model.wishlistCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							wishlistcell,
							{raised: _p0._1});
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{wishlistCell: newCell}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'BtcCellType':
						var coincell = model.btcCoinCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							coincell,
							{raised: _p0._1});
						return {
					...
					case 'NemCellType':
						var coincell = model.nemCoinCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							coincell,
							{raised: _p0._1});
						return {
					...
					default:
						var coincell = model.dogeCoinCell;
						var newCell = _elm_lang$core$Native_Utils.update(
							coincell,
							{raised: _p0._1});
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{dogeCoinCell: newCell}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				}
		}
	});
var _user$project$Main$DogeCellType = {ctor: 'DogeCellType'};
var _user$project$Main$NemCellType = {ctor: 'NemCellType'};
var _user$project$Main$BtcCellType = {ctor: 'BtcCellType'};
var _user$project$Main$WishlistCellType = {ctor: 'WishlistCellType'};
var _user$project$Main$FacebookCellType = {ctor: 'FacebookCellType'};
var _user$project$Main$GithubCellType = {ctor: 'GithubCellType'};
var _user$project$Main$TwitterCellType = {ctor: 'TwitterCellType'};
var _user$project$Main$UserCellType = {ctor: 'UserCellType'};
var _user$project$Main$model = {
	...
	userCell: {
		...
		cellType: _user$project$Main$UserCellType,
		url: 'https://oppai.github.io',
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S700)
	},
	twitterCell: {
		raised: false,
		image: '/images/twitter.png',
		cellType: _user$project$Main$TwitterCellType,
		url: 'https://twitter.com/kodam',
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Blue, _debois$elm_mdl$Material_Color$S50)
	},
	githubCell: {
		raised: false,
	...
	facebookCell: {
		...
		cellType: _user$project$Main$FacebookCellType,
		url: 'https://www.facebook.com/hiroaki.murayama.399',
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Teal, _debois$elm_mdl$Material_Color$S300)
	},
	wishlistCell: {
		raised: false,
		image: '/images/amazon.png',
		cellType: _user$project$Main$WishlistCellType,
		url: 'http://www.amazon.co.jp/registry/wishlist/21DI5R3QOUBXI/',
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Amber, _debois$elm_mdl$Material_Color$S300)
	},
	btcCoinCell: {
		raised: false,
		image: '/images/counter-party.png',
		qrImage: '/images/counter-party-qr.png',
		cellType: _user$project$Main$BtcCellType,
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Yellow, _debois$elm_mdl$Material_Color$S600),
	...
	nemCoinCell: {
		...
		cellType: _user$project$Main$NemCellType,
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Teal, _debois$elm_mdl$Material_Color$S600),
		title: 'NEM',
	...
	dogeCoinCell: {
		...
		cellType: _user$project$Main$DogeCellType,
		color: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Brown, _debois$elm_mdl$Material_Color$S600),
		title: 'DOGE',
...
var _user$project$Main$init = A2(
	...
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Task$perform, _user$project$Main$WindowResult, _elm_lang$window$Window$size),
		_1: {ctor: '[]'}
	});
